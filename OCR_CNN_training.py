...
path = 'E:\Projects\Handwritten\myData'
testRatio = 0.2
valRatio = 0.2
...
X_train, X_validation, y_train, y_validation = train_test_split(X_train, y_train, test_size=valRatio, random_state=0)
print(X_train.shape)
print(X_test.shape)
